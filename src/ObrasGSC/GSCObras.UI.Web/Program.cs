...
var apimConfig = builder.Configuration.GetSection("ApimConfig").Get<ApimConfig>();
builder.Services.AddApim(apimConfig);

builder.Services.AddScoped<IApimGSCObras, ApimGSCObras>();
