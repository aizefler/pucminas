using GSCObras.Mobile.Models.About;
...
namespace GSCObras.Mobile.ViewModels.About
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:GSCObras.Mobile.ViewModels.About.AboutUsViewModel"/> class.
        /// </summary>
        ...
        {
            var file = "GSCObras.Mobile.Data." + fileName;
